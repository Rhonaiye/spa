...
const Community = ()=>{
  return (
    <div className='background bg-[#F3F4EF] py-20 px-2 lg:px-2'>
        ...
        <h1 className='text-2xl mb-7 font-bold text-neutral-800 ml-7 lg:ml-12'>Community backed</h1>
        <div className='grid grid-cols-1 lg:grid-cols-3 gap-10 place-items-center lg:justify-items-center'>
           
           <div className='lg:w-3/4 w-[42vh]'>
           ...
           <Image src={secure} alt='secure and compliant' className='rounded-xl'/>
              ...
              <div className='mt-4 flex flex-col gap-2 mb-3'>
                 ...
                 <p className='text-sm text-neutral-800'>We're serious about security. Your spending is safe and private.</p>
              </div>
              <FiArrowUpRight size={40}/>
           </div>
        </div>
