...
const Footer = () => {
  return (
    <footer className="bg-[#191B1B] text-white py-20 pt-[25vh] lg:pt-[38vh] px-6 lg:px-20">
      <div className="flex flex-col md:flex-row lg:flex-row justify-between lg:items-start mb-8">
        
        {/* Left Section */}
        <div className="lg:w-1/4 md:w-1/4 mb-8 lg:mb-0 lg:mr-6">
        ...
        {/* Link Sections */}
        <div className="lg:flex lg:justify-between lg:w-3/4 md:flex md:gap-x-9  lg:space-y-0">
