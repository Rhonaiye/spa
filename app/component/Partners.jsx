...
const Partners = ()=>{
  return (
    ...
    <div className="flex flex-col lg:flex-row justify-center place-items-end items-center gap-5">
      ...
      <div className="flex items-center gap-2 max-sm:mb-5">
        ...
        <div className='parent flex flex-col lg:flex-row items-center lg:justify-evenly'>
